# Parse [![API reference](https://img.shields.io/badge/godoc-reference-5272B4)](https://pkg.go.dev/github.com/politepixels/tdewolff-parse/v2?tab=doc) [![Go Report Card](https://goreportcard.com/badge/github.com/politepixels/tdewolff-parse)](https://goreportcard.com/report/github.com/politepixels/tdewolff-parse) [![Coverage Status](https://coveralls.io/repos/github/tdewolff/parse/badge.svg?branch=master)](https://coveralls.io/github/tdewolff/parse?branch=master) [![Donate](https://img.shields.io/badge/patreon-donate-DFB317)](https://www.patreon.com/tdewolff)
...
The lexers are implemented using `buffer.Lexer` in https://github.com/politepixels/tdewolff-parse/buffer and the parsers work on top of the lexers. Some subpackages have hashes defined (using [Hasher](https://github.com/tdewolff/hasher)) that speed up common byte-slice comparisons.
...
[See README here](https://github.com/politepixels/tdewolff-parse/tree/master/css).
...
[See README here](https://github.com/politepixels/tdewolff-parse/tree/master/html).
...
[See README here](https://github.com/politepixels/tdewolff-parse/tree/master/js).
...
[See README here](https://github.com/politepixels/tdewolff-parse/tree/master/json).
...
[See README here](https://github.com/politepixels/tdewolff-parse/tree/master/xml).
