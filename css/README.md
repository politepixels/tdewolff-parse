# CSS [![API reference](https://img.shields.io/badge/godoc-reference-5272B4)](https://pkg.go.dev/github.com/politepixels/tdewolff-parse/v2/css?tab=doc)
...
Run the following command
	...
	go get -u github.com/politepixels/tdewolff-parse/v2/css

or add the following import and run project with `go get`

	import "github.com/politepixels/tdewolff-parse/v2/css"
